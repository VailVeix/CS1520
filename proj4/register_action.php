...
<?php
  ...
  if($name == NULL){
    ...
    header("location: /~acs119/php/assign4/register.php");
  }
  if($password == NULL){
  ...
  $query = "insert into Users values('$max', '$email', '$name', '$password')";
  $db->query($query) or die ("Invalid: " . $db->error);

  echo "<h1>Registration Complete</h1>";
  echo "<br/><br/>";
  echo "<a href='http://cs1520.cs.pitt.edu/~acs119/php/assign4/login.php'>Log in?</a>";
